...
export interface SwipeCardHandle {
  flyOff: (direction: SwipeDirection) => Promise<void>;
}
...
export const SwipeCard = forwardRef<SwipeCardHandle, SwipeCardProps>(
  function SwipeCard({ profile, onSwipe, isTop, stackIndex }, ref) {
    ...
    const flyOff = async (direction: SwipeDirection) => {
      if (exiting) return;
      setExiting(true);
      const flyX = direction === "right" ? 600 : -600;
      const flyRotate = direction === "right" ? 20 : -20;
